...
Meteor.methods({
  'dota2bot.updateDota2Profile'() {
    ...
    if(Meteor.isServer){
      ...
      const wrappedGetAccountId = Meteor.wrapAsync(testBot.Dota2Bot.dota2.ToAccountId);//Converts a 64bit Steam ID to a Dota2 account ID by deleting the 32 most significant bits
